  ...
  return (
    <div className="flex-1 flex min-h-0 relative w-full overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 w-full relative">
        {/* Floating Mobile Filter Trigger Button on Map (bottom edge, clear of
            zoom controls, legend, and the detail-panel drawer) */}
        <div className="lg:hidden absolute bottom-9 right-2.5 z-[1000]">
          <button
            type="button"
            onClick={() => setIsMobileFiltersOpen(true)}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-bold bg-slate-900/95 dark:bg-blue-600 text-white shadow-lg border border-white/15 dark:border-blue-400/30 hover:bg-slate-800 active:scale-[0.98] transition-all backdrop-blur-sm"
          >
